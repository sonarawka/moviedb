...
const TvMedia = (props) => {
    ...
    const videoApi = async () => {
        const url = `https://api.themoviedb.org/3/tv/${props.id}/videos?api_key=184d4ae5b2d8ff18eca3972237dc1b9f`
    ...
    const imageApi = async () => {
        const url = `https://api.themoviedb.org/3/tv/${props.id}/images?api_key=184d4ae5b2d8ff18eca3972237dc1b9f`
