...
const Tab = (props) => {
    ...
    const url =`https://api.themoviedb.org/3/movie/${id}/reviews?api_key=184d4ae5b2d8ff18eca3972237dc1b9f&language=en-US&page=1`
    ...
    return (
        ...
        <p className='my-3'><Link className={`${classes.AllReview}`} to={{pathname:`/movies/${id}/review`}} state={{imgurl:imgurl, title:title, release_date:release_date, result:result, id:id}}>Read All Reviews</Link></p>
        </div>
    )
}
