            ...
            <div className='container'>
                <div className='row'>
                    ...
                    <div className='col-md-6'>
                        ...
                        <Crew key='Art' crew={crew} department='Art' />
                        <Crew key='Directing' crew={crew} department='Directing' />
                        <Crew key='Editing' crew={crew} department='Editing' />
                        <Crew key='Production' crew={crew} department='Production' />
                        <Crew key='Sound' crew={crew} department='Sound' />
                        <Crew key='Visual' crew={crew} department='Visual Effects' />
                        <Crew key='Writing' crew={crew} department='Writing' />
