...
import Carditems from '../Tvdetails/Carditems'
...
const NavTv = () => {
    ...
    const loadpopular = async () => {
        let api = `https://api.themoviedb.org/3/tv/popular?api_key=184d4ae5b2d8ff18eca3972237dc1b9f&language=en-US&page=${pageno}`
...
>
                ...
                <div className='row'>
                    <h3 className='my-3'>Popular TVs</h3>
                    {results.map((result) => {
